...
#define INKAGENT_BOARD_NAME "x4pro"
#elif FREEINK_DEVICE_X4CLASSIC
#define INKAGENT_BOARD_NAME "x4c"
#elif FREEINK_DEVICE_X4 || FREEINK_DEVICE_X3
#define INKAGENT_BOARD_NAME "x4"
#elif FREEINK_DEVICE_PAPERMONO
#define INKAGENT_BOARD_NAME "papermono"
#elif FREEINK_DEVICE_STICKY
#define INKAGENT_BOARD_NAME "sticky"
#elif FREEINK_DEVICE_M5PAPER
#define INKAGENT_BOARD_NAME "m5paper"
#elif FREEINK_DEVICE_LILYGO
#define INKAGENT_BOARD_NAME "lilygo"
#elif FREEINK_DEVICE_M5
#define INKAGENT_BOARD_NAME "m5"
#elif FREEINK_DEVICE_MURPHY
#define INKAGENT_BOARD_NAME "murphy"
#elif FREEINK_DEVICE_DELINK
#define INKAGENT_BOARD_NAME "delink"
#else
...
constexpr size_t MAGIC_LEN = sizeof("INKAGENT-BOARD-V1:") - 1;
}  // namespace

const char TAG[] = "INKAGENT-BOARD-V1:" INKAGENT_BOARD_NAME ";";
