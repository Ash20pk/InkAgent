...
// Board-identity tag embedded in every InkAgent image, plus a streaming
...
//
// The tag is "INKAGENT-BOARD-V1:<board>;" stored once in .rodata — the
// scanner's needle references the same array, so a InkAgent image contains
