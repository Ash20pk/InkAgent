...
class EpubReaderActivity final : public ReaderActivity {
  ...
  // InkAgent: capture the passage around the current page, release the EPUB
  // like sync does, and hand off to AskBookActivity.
  bool launchAskBook();
 ...
 public:
  ...
  InkAgentPosition getCurrentPosition() const;
};
