...
struct SettingInfo {
  StrId nameId;
  SettingType type;
  uint8_t InkAgentSettings::* valuePtr = nullptr;
  ...
  // Direct char[] string fields (for settings stored in InkAgentSettings)
  size_t stringOffset = 0;
  size_t stringMaxLen = 0;

  // Dynamic accessors (for settings stored outside InkAgentSettings, e.g. KOReaderCredentialStore)
  ...
  static SettingInfo Toggle(StrId nameId, uint8_t InkAgentSettings::* ptr, const char* key = nullptr,
  ...
  static SettingInfo Enum(StrId nameId, uint8_t InkAgentSettings::* ptr, std::vector<StrId> values,
  ...
  static SettingInfo Value(StrId nameId, uint8_t InkAgentSettings::* ptr, const ValueRange valueRange,
                           const char* key = nullptr, StrId category = StrId::STR_NONE_OPT) {
    SettingInfo s;
    s.nameId = nameId;
