...
// to the inkagent-fonts repo under the "sd-fonts-m<META>-b<BIN>" tag. The tag
...
#define FONT_MANIFEST_URL                                                                                           \
  /* external font pack, published by the CrossPoint project */ "https://github.com/crosspoint-reader/crosspoint-fonts/releases/download/sd-fonts-m" FONT_MANIFEST_URL_STRINGIFY( \
