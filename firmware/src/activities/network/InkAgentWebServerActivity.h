...
#include "network/InkAgentWebServer.h"
...
/**
 * InkAgentWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the InkAgentWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class InkAgentWebServerActivity final : public Activity {
  ...
  std::unique_ptr<InkAgentWebServer> webServer;
 ...
 public:
  explicit InkAgentWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("InkAgentWebServer", renderer, mappedInput) {}
