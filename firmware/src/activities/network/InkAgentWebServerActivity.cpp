#include "InkAgentWebServerActivity.h"
...
constexpr const char* AP_SSID = "InkAgent-Reader";
constexpr const char* AP_PASSWORD = nullptr;  // Open network for ease of use
constexpr const char* AP_HOSTNAME = "inkagent";
...
void InkAgentWebServerActivity::onEnter() {
  Activity::onEnter();
...
void InkAgentWebServerActivity::onExit() {
  Activity::onExit();
...
void InkAgentWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void InkAgentWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void InkAgentWebServerActivity::startAccessPoint() {
...
void InkAgentWebServerActivity::startWebServer() {
  ...
  webServer.reset(new InkAgentWebServer());
  webServer->begin();
...
void InkAgentWebServerActivity::loop() {
...
void InkAgentWebServerActivity::render(RenderLock&&) {
...
void InkAgentWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
