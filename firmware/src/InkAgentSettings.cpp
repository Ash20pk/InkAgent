...
void InkAgentSettings::validateFrontButtonMapping(InkAgentSettings& settings) {
...
uint8_t InkAgentSettings::sleepTimeoutEnumToMinutes(const uint8_t legacyValue) {
  switch (legacyValue) {
    case SLEEP_1_MIN:
      return 1;
    case SLEEP_5_MIN:
...
bool InkAgentSettings::fromJson(JsonVariantConst doc) {
  InkAgentSettings& s = *this;
...
InkAgentSettings::StatusBarSpec InkAgentSettings::statusBarSpec() const {
  StatusBarSpec spec;
...
unsigned long InkAgentSettings::getSleepTimeoutMs() const {
...
int InkAgentSettings::getRefreshFrequency() const {
...
void InkAgentSettings::clearSdFontFamily() {
...
int InkAgentSettings::getReaderFontId() const {
