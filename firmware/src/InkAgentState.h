...
class InkAgentState : public PersistableStore<InkAgentState> {
  InkAgentState() = default;

  friend class PersistableStore<InkAgentState>;
...
#define APP_STATE InkAgentState::getInstance()
