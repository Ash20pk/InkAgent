...
class InkAgentSettings : public PersistableStore<InkAgentSettings> {
 private:
  ...
  InkAgentSettings() = default;

  friend class PersistableStore<InkAgentSettings>;
 ...
 public:
  ...
  static const char* getFilePath() { return "/.inkagent/settings.json"; }
  void toJson(JsonDocument& doc) const;
  bool fromJson(JsonVariantConst doc);

  static void validateFrontButtonMapping(InkAgentSettings& settings);
...
#define SETTINGS InkAgentSettings::getInstance()
