...
bool MappedInputManager::wasPowerConfirmClick() const {
  if (!gpio.hasTouch() || SETTINGS.shortPwrBtn != InkAgentSettings::SHORT_PWRBTN::PWR_CONFIRM) return false;
