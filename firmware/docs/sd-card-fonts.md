...
InkAgent supports loading additional fonts from the SD card, including fonts
...
1. Connect your InkAgent reader to Wi-Fi
...
1. Download font files from the
   [font pack repository](https://github.com/crosspoint-reader/crosspoint-fonts)
...
3. Insert the SD card and power on your InkAgent reader
...
To avoid shipping a large CJK glyph set in flash, InkAgent instead reuses the
...
so InkAgent loads your SD family at those sizes too and maps each UI font to
