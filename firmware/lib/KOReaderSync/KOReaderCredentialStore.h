...
class KOReaderCredentialStore : public PersistableStore<KOReaderCredentialStore> {
 ...
 public:
  static const char* getFilePath() { return "/.inkagent/koreader.json"; }
  ...
  // Whether API calls target the InkAgent sync server that supports protocol extensions.
  bool usesInkAgentSyncServer() const;
