...
ProgressComparison compareProgress(const InkAgentPosition& local, const float localPercentage,
                                   const InkAgentPosition& remote, const float remotePercentage) {
...
RemoteRecordChoice selectRemoteRecord(const InkAgentPosition& primary, const float primaryPercentage,
                                      const InkAgentPosition& alternate, const float alternatePercentage) {
