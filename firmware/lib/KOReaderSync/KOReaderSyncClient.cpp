...
namespace {
// Device identifier for InkAgent reader
constexpr char DEVICE_NAME[] = "InkAgent";
constexpr char DEVICE_ID[] = "inkagent-reader";
...
KOReaderSyncClient::Error KOReaderSyncClient::updateProgress(const KOReaderProgress& progress) {
  ...
  if (progress.position.has_value() && KOREADER_STORE.usesInkAgentSyncServer()) {
    // InkAgent-specific extension: do not send it to third-party KOSync servers.
