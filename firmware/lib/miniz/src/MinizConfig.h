/* InkAgent only needs miniz's low-level streaming inflate (tinfl). The
...
// inkagent_ (NOT freeink_) so a future branch that links FreeInkBook's
// identically-renamed copy does not collide.
#define tinfl_decompress inkagent_tinfl_decompress
#define tinfl_decompress_mem_to_heap inkagent_tinfl_decompress_mem_to_heap
#define tinfl_decompress_mem_to_mem inkagent_tinfl_decompress_mem_to_mem
#define tinfl_decompress_mem_to_callback inkagent_tinfl_decompress_mem_to_callback
#define mz_crc32 inkagent_mz_crc32
#define mz_adler32 inkagent_mz_adler32
#define mz_free inkagent_mz_free
