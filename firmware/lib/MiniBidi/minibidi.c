/*
 * minibidi.c — Unicode Bidirectional Algorithm (UAX #9) for InkAgent/ESP32C3
 *
 ...
 *
 * InkAgent deviations from the upstream code, each marked inline:
 ...
 *      in its bidi_char array; in InkAgent they are real array entries
...
/* ── InkAgent extension: joining types outside U+0621–U+064A ──────────
...
/* ── InkAgent extension: presentation forms outside U+0621–U+064A ─────
...
/* InkAgent deviation 1: NSM marks (harakat) sit between letters in our
