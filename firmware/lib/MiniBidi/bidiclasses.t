/* bidiclasses.t — bidi class table for InkAgent RTL (Hebrew/Arabic) epub.
 *
 * Coverage rationale:
 *   Hebrew and Arabic-script languages (Arabic, Farsi, Urdu, Sindhi, Pashto,
 *   Kurdish) are the RTL targets. InkAgent also renders Latin and Cyrillic
 ...
 *   scripts InkAgent's fonts don't support (CJK, Devanagari, etc.)
...
/* ── Cyrillic (L) ────────────────────────────────────────────────────── */
/* Required: InkAgent supports Russian, Ukrainian, Bulgarian, etc.
...
/* Covers accented chars for Vietnamese, Welsh, Romanian, etc.
   Not currently rendered by InkAgent fonts, but costs only 2 table rows. */
{0x1E00, 0x1EFF, L},
