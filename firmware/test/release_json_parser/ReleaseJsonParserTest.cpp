...
const char* kRealisticPretty = R"({
  "url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/12345",
  "assets_url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/12345/assets",
  "upload_url": "https://uploads.github.com/repos/Ash20pk/InkAgent/releases/12345/assets{?name,label}",
  "html_url": "https://github.com/Ash20pk/InkAgent/releases/tag/v2.4.1",
  "id": 12345,
  "author": {
    "login": "releasebot",
    "id": 99887766,
  ...
  "assets": [
    {
      "url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100001",
      "id": 100001,
      "node_id": "RA_kwDOAbCdEf4AAGHR",
      "name": "inkagent-reader-v2.4.1-source.zip",
      "label": null,
      "uploader": {
        "login": "releasebot",
        "id": 99887766,
      ...
      "browser_download_url": "https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/inkagent-reader-v2.4.1-source.zip"
    },
    {
      "url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100002",
      "id": 100002,
      ...
      "browser_download_url": "https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/firmware.bin"
    },
    {
      "url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100003",
      "id": 100003,
      "node_id": "RA_kwDOAbCdEf4AAGHR",
      ...
      "browser_download_url": "https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/checksums.sha256"
    }
  ],
  "tarball_url": "https://api.github.com/repos/Ash20pk/InkAgent/tarball/v2.4.1",
  "zipball_url": "https://api.github.com/repos/Ash20pk/InkAgent/zipball/v2.4.1",
  "body": "## What's Changed\n\n* Fixed orientation crash (#123)\n* Improved EPUB rendering performance\n* Added Serbian translation\n\n**Full Changelog**: https://github.com/Ash20pk/InkAgent/compare/v2.4.0...v2.4.1",
  "reactions": {
    "url": "https://api.github.com/repos/Ash20pk/InkAgent/releases/12345/reactions",
    "total_count": 5,
    "+1": 3,
    "-1": 0,
    "laugh": 1,
...
const char* kRealisticMinified =
    R"({"url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/12345","assets_url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/12345/assets","id":12345,"author":{"login":"releasebot","id":99887766,"node_id":"MDQ6VXNlcjk5ODg3NzY2","type":"User","site_admin":false},"tag_name":"v2.4.1","target_commitish":"main","name":"InkAgent v2.4.1","draft":false,"prerelease":false,"assets":[{"url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100001","id":100001,"name":"inkagent-reader-v2.4.1-source.zip","uploader":{"login":"releasebot","id":99887766},"content_type":"application/zip","state":"uploaded","size":2048576,"download_count":42,"browser_download_url":"https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/inkagent-reader-v2.4.1-source.zip"},{"url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100002","id":100002,"name":"firmware.bin","uploader":{"login":"releasebot","id":99887766},"content_type":"application/octet-stream","state":"uploaded","size":1572864,"download_count":187,"browser_download_url":"https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/firmware.bin"},{"url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/assets/100003","id":100003,"name":"checksums.sha256","uploader":{"login":"releasebot","id":99887766},"content_type":"text/plain","state":"uploaded","size":192,"download_count":15,"browser_download_url":"https://github.com/Ash20pk/InkAgent/releases/download/v2.4.1/checksums.sha256"}],"body":"## What's Changed\n\n* Fixed orientation crash","reactions":{"url":"https://api.github.com/repos/Ash20pk/InkAgent/releases/12345/reactions","total_count":5,"+1":3}})";
...
TEST(ReleaseJsonParser, ConfiguredFirmwareNameMatch) {
  const char* json = R"({
      ...
      "assets": [
        ...
        {"name": "inkagent-1.6.1-sticky.bin", "browser_download_url": "https://sticky", "size": 200},
        {"name": "inkagent-1.6.1-x4pro.bin", "browser_download_url": "https://x4pro", "size": 300}
      ]
    })";

  ReleaseJsonParser p;
  p.setFirmwareAssetName("inkagent-1.6.1-x4pro.bin");
  p.feed(json, strlen(json));
...
TEST(ReleaseJsonParser, ConfiguredFirmwareNameIsNotOverwrittenBySameSuffix) {
  const char* json = R"({
      "tag_name": "1.6.1",
      "assets": [
        {"name": "inkagent-1.6.1-x4pro.bin", "browser_download_url": "https://correct", "size": 100},
        {"name": "inkagent-1.6.0-x4pro.bin", "browser_download_url": "https://stale", "size": 200}
      ]
    })";
