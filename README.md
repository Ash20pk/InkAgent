...
relay/          Node 22, zero dependencies: pairing, agent, app hosting, dashboard, traces
...
Sign-in is gated by `INK_ACCESS_CODE` until real OAuth lands. The device pins
ISRG Root X1 and X2 rather than trusting any certificate.
